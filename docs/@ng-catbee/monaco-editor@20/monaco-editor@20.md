---
id: monaco-editor@20
title: monaco-editor@20
---

# @ng-catbee/monaco-editor@20

A modern Angular library that seamlessly integrates the Monaco Editor (v20.x.x) with support for single and diff editors.

### Getting Started

- [Introduction](./intro) - Overview, features, demos, and compatibility
...
- [API Documentation](./api-reference) - Complete API reference for Monaco Editor components
